    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <Card className="h-[70vh] flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col overflow-hidden min-h-0">
          <div ref={messagesEndRef} className="flex-1 overflow-y-auto pr-4 space-y-2 scrollbar-thumb-amber-50">
            {messages.length === 0 && (
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isOwn ? "bg-primary text-primary-foreground ml-auto rounded-br-none" : "bg-muted rounded-bl-none",
                  )}
                >
                  {displayText}
                </div>
