...
export const ChatPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Chat - Innowise RTSP</title>
        <meta name="description" content="Browse our chat." />
        <meta property="og:title" content="Chat - Innowise RTSP" />
        <meta property="og:description" content="Browse our chat." />
      </Helmet>
